...
recievedMessage::recievedMessage(recievedMessage &other) : _messageCode(other._messageCode), _socket(std::move(other._socket)), _user(other._user), _values(other._values) //TODO should we use std::move?
{
}